...
Template based on 'User Profile Edit' Template for GNU FM
...
<form class="form-signin" action='{$base_url}/user-edit.php' method='post'>
    ...
    <div class="form-group mb-3">
        ...
        <input size="40" maxlength="40" type="text" class="form-control form-control-lg" name='location' id='location' value='{$location|escape:'html':'UTF-8'}' placeholder="Cyberspace">
