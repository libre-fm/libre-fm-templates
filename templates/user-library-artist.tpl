...
Template based on 'User Library Artist' Template for GNU FM
...
<div class="row">
    <div class="col-sm-3">
        <img class="img-responsive img-thumbnail img-lazy margin-top" src="{$page->artist_image}" alt loading="lazy" width="250" height="250" />
    </div>
    <div class="col-sm-9">
