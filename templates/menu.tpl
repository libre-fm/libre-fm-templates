...
<ul id="nav" class="navbar-nav ms-auto">
    ...
    <li class="nav-item">{if ($this_user_first_year > 2024)}<a href="/user/{$this_user->name}/recap/2025" title="Your 2025 recap">2025</a>{/if}{if ($this_user_first_year)}{if ($this_user_first_year < 2024)}&mdash;<a href="/user/{$this_user->name}/recap/{$this_user_first_year}" title="Your first year of data recapped!">{$this_user_first_year}</a>{/if}{/if}</li>
    <li class="nav-item"><a class="edit-profile-link" href="/user-edit.php">Settings</a></li>
