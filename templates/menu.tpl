...
Template based on 'Menu' Template for GNU FM
...
<ul id="nav" class="navbar-nav ms-auto">
    ...
    <li class="nav-item"><i class="bi bi-search"></i> <a href="/search.php">Search</a></li>
    {else}
    <li class="nav-item"><i class="bi bi-person-badge"></i> <a href="/user-edit.php">Edit your profile</a>
    {/if}
    ...
    <li class="nav-item"><i class="bi bi-envelope"></i> <a href="mailto:support@libre.fm?subject=Libre.fm%20help">support@libre.fm</a> (please include a useful subject line!)</li>
