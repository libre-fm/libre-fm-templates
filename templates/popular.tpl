...
*}
	...
	<ul id="popular">
	    ...
	    <li style='font-size:{$tagcloud[i].size}'><a href='{$tagcloud[i].pageurl|escape:'url'}' title='{t loves=$tagcloud[i].count}This artist was loved %1 times{/t}' rel='tag'>{$tagcloud[i].name}</a></li>
	    {/section}
	</ul>
