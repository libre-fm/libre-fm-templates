...
Template based on 'Welcome logged in (homepage)' Template for GNU FM
...
{if ($recents)}
<h3 class="text-center text-balance">Songs listened to by the Libre.fm community in the last few minutes</h3>
{$recents}
{/if}
