...
Template based on 'Privacy policy' Template for GNU FM
Copyright (c) 2009 Free Software Foundation, Inc

'Privacy policy' Template for Libre.fm
...
<ul>
    ...
    <li>You may request a copy of your data by emailing <a href="mailto:support@libre.fm?subject=Data%20request">support@libre.fm</a> (please include a useful subject line!) from your registered email address and providing your username. This is a manual process. We endeavor to handle requests in 72 hours.</li>
</ul>
