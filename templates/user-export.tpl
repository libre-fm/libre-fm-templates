...
Template based on 'User Export' Template for GNU FM
Copyright (c) 2009 Free Software Foundation, Inc

'User Export' Template for Libre.fm
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p>Right now focus is on the rewrite which will make this automated.</p>
