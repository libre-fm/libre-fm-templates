...
Template based on 'User Single Scrobble (HTML)' Template for GNU FM
      ...
      <div class="card-body">
        <div class="d-flex flex-row">
          ...
          <h3 class="card-title" style="font-size: 1.25rem"><span class="p-music-track">{$track->name|escape:'html':'UTF-8'}</span></h3>
              ...
              <p><a href="{$track->getURL()}" class="btn btn-primary btn-sm"><i class="bi bi-file-music"></i> Track page for '{$track->name}'</a></p>
          {else}
